 ...
 * The scoring function used to rank recommendation candidates is the mean similarity over the target cases.
 */
...
public class MeanRecommender extends Recommender {
	 ...
	 */
	public MeanRecommender(CaseSimilarity caseSimilarity, Casebase cb) {
