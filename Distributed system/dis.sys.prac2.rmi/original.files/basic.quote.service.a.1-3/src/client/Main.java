...
// 			// BrokerService b = (BrokerService)registry.lookup("BROKER_SERVICE") // looking up when seperated. 
// 			// the binds sends it to the regestry... cant bind an object to the regestry... stream of bytes 
// 			BrokerService b = (BrokerService) UnicastRemoteObject.exportObject(new BrokerService(), 0); 
// 			registry.bind("BROKER_SERVICE", b);
