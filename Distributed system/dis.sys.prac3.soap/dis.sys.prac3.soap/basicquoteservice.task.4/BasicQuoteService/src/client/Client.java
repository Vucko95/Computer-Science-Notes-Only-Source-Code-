...
public class Client {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BusinessList findBusiness = WebServicesClientHelper.partialBusinessNameSearch(inquiry, token,
					"brokerBusiness" + UDDIConstants.WILDCARD);
			...
			BrokerService brokerService = service.getPort(new QName("http://core.service/", "BrokerServicePort"),
					BrokerService.class);
