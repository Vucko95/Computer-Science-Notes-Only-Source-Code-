...
public static void main(String[] args) {
	...
	try {
		...
		if (clerk == null) {
			throw new Exception("no clerk");
		}
		String BusinessKey = WebServicesHelper.createBusiness("GPQBusiness", clerk);
		BusinessService myService = WebServicesHelper.createWSDLService("QuotationService", BusinessKey, "http://localhost:8080/QuotationService/GPQService?wsdl");
